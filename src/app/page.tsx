  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
          <Card className="text-center">
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="text-xl sm:text-2xl font-bold text-gray-900">{homeData.stats.activeStores}</div>
          ...
          <Card className="text-center">
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="text-xl sm:text-2xl font-bold text-gray-900">{homeData.stats.totalProducts}+</div>
          ...
          <Card className="text-center">
            <CardContent className="p-4 sm:p-6">
              ...
              <div className="text-xs sm:text-sm text-gray-600">WhatsApp Support</div>
            </CardContent>
          </Card>
        </div>
        ...
        {/* Store Highlights */}
        {homeData.stores.length > 0 && (
          <section id="stores" className="mb-12 sm:mb-16">
            <div className="text-center mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Stores</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              {homeData.stores.map((store) => (
                <Card key={store.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <div
                    className="h-32 sm:h-48 flex items-center justify-center relative"
                  ...
                  >
                    ...
                    <Badge className="absolute top-2 sm:top-4 right-2 sm:right-4 text-xs sm:text-sm">
        ...
        {/* Features */}
        <div className="text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 sm:mb-8">Why Choose Dual Store?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🛍️</div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Curated Selection</h3>
              <p className="text-sm sm:text-base text-gray-600">Handpicked products from trusted brands and quality sellers</p>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">💬</div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">WhatsApp Checkout</h3>
              <p className="text-sm sm:text-base text-gray-600">Easy ordering through WhatsApp with personalized service</p>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🚀</div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Fast Delivery</h3>
              <p className="text-sm sm:text-base text-gray-600">Quick and reliable delivery across all Indonesia</p>
            </div>
          </div>
        </div>
      </main>
