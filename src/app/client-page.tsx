        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 z-10">
          <div className="text-center space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-4">
              ...
              <span className="text-sm font-medium">Platform E-Commerce Terpercaya di Indonesia</span>
            </div>
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-50 max-w-3xl mx-auto leading-relaxed">
              ...
              Belanja dengan aman, cepat, dan terpercaya.
            </p>
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-green-50/30">
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">Beragam pilihan produk</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="group relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-purple-50/30">
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">Berbagai kategori produk</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-blue-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-blue-600">Keunggulan Kami</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Mengapa Pilih Dual Store?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Platform e-commerce terpercaya dengan berbagai keunggulan untuk pengalaman belanja terbaik
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                description: "Pengiriman ke seluruh Indonesia dengan layanan ekspres",
                color: "green"
              },
              {
                icon: CreditCard,
              ...
              <Card key={index} className="group border-0 shadow-md hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-gray-50/50">
                <CardContent className="p-6 text-center">
                  <div className={cn(
                    ...
                    feature.color === "blue" && "bg-gradient-to-br from-blue-500 to-blue-600 shadow-blue-500/25",
                    feature.color === "green" && "bg-gradient-to-br from-green-500 to-emerald-600 shadow-green-500/25",
                    feature.color === "purple" && "bg-gradient-to-br from-purple-500 to-purple-600 shadow-purple-500/25",
                    feature.color === "orange" && "bg-gradient-to-br from-orange-500 to-amber-600 shadow-orange-500/25"
                  )}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-purple-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-purple-600">Toko Pilihan</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Toko Unggulan Kami
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Temukan pilihan premium dari toko-toko terbaik dan terpercaya di seluruh Indonesia
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {stores.map((store) => (
              <Card key={store.id} className="group border-0 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white">
                <div
                ...
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-6 line-clamp-3 min-h-[4.5rem]">
                    {store.description ? store.description.substring(0, 120) + '...' : 'Temukan produk menakjubkan dengan kualitas terbaik dari toko ini'}
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-green-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-green-600">Produk Terbaru</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Produk Unggulan
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (
              <Card key={product.id} className="group border-0 shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden bg-white">
                ...
                <CardContent className="p-5">
                  <div className="space-y-3">
                    <div>
                      <Badge variant="secondary" className="text-xs mb-2 bg-purple-50 text-purple-700 border-purple-200">
                        {product.store.name}
                      </Badge>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-orange-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-orange-600">Cara Kerja</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: "1", title: "Pilih Toko", description: "Jelajahi berbagai toko premium dan pilih yang sesuai kebutuhan", icon: StoreIcon },
              { step: "2", title: "Pilih Produk", description: "Temukan produk yang Anda cari dengan mudah menggunakan fitur pencarian", icon: Search },
              { step: "3", title: "Checkout", description: "Lakukan checkout dengan berbagai metode pembayaran yang tersedia", icon: ShoppingCart },
              { step: "4", title: "Terima Barang", description: "Tunggu barang sampai di rumah dengan pengiriman cepat dan aman", icon: Package }
            ].map((item, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-yellow-50 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-yellow-600">Testimoni</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Apa Kata Pelanggan Kami?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Ribuan pelanggan puas telah mempercayai Dual Store untuk kebutuhan belanja mereka
            </p>
          </div>
            ...
            {[
              {
                ...
                location: "Jakarta",
                rating: 5,
                comment: "Platform yang sangat mudah digunakan dan produknya berkualitas. Pengiriman cepat dan packaging rapi. Sangat recommended!",
                avatar: "👨‍💼"
              },
              {
                name: "Siti Nurhaliza",
                ...
                location: "Bandung",
                rating: 5,
                comment: "Belanja jadi lebih praktis dengan Dual Store. Banyak pilihan toko dan produk, harga juga kompetitif. Customer service responsif banget!",
                avatar: "👩‍💼"
              },
              {
                name: "Ahmad Rizki",
                ...
                location: "Surabaya",
                rating: 5,
                comment: "Sebagai mahasiswa, saya sangat suka dengan berbagai promo yang ditawarkan. Kualitas produk sesuai dengan deskripsi dan harganya terjangkau.",
                avatar: "👨‍🎓"
              }
      ...
      <section className="py-20 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-700 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            <Sparkles className="h-4 w-4 text-yellow-300" />
            <span className="text-sm font-medium">Dapatkan Penawaran Spesial</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Dapatkan Update & Promo Terbaru
          </h2>
          <p className="text-xl text-blue-50 mb-8 max-w-2xl mx-auto">
            Berlangganan newsletter kami dan dapatkan penawaran eksklusif, diskon spesial, dan update produk terbaru langsung di email Anda
          </p>
